  ...
  head: () => ({
    meta: [
      { title: "Mahnoor Fatima — Video Editor & Motion Designer" },
      {
        name: "description",
        content:
          "Cinematic short-form, long-form & motion graphics editing by Mahnoor Fatima. Reels, Shorts, podcasts and YouTube videos.",
      },
      { property: "og:title", content: "Mahnoor Fatima — Video Editor" },
      {
        property: "og:description",
        content: "I don't edit videos. I craft stories.",
      },
    ],
  }),
});
...
const youtubeVideos = [
  { id: "LlXcZjn6eYs", title: "Featured Edit · Story Cut", duration: "Long-form" },
  { id: "jcfoaGfi7lA", title: "Cinematic Showcase", duration: "Long-form" },
  { id: "WCL_Zshmuss", title: "Narrative Edit", duration: "Long-form" },
  { id: "jBGfKWSZwuA", title: "Featured YouTube Video", duration: "Long-form" },
];

const youtubeShorts = [
  { id: "4XfXhpL9PrM", title: "Short · 01" },
  { id: "KozzgXlARS8", title: "Short · 02" },
  { id: "294xNj2qer0", title: "Short · 03" },
  { id: "Lcwv5FMAtj8", title: "Short · 04" },
  { id: "HxODOdRMYco", title: "Short · 05" },
  { id: "UJfPXno3XaU", title: "Short · 06" },
  { id: "TQG1H_mM0Dc", title: "Short · 07" },
  { id: "4notL3NmysM", title: "Short · 08" },
  { id: "pO4XPNQC8yA", title: "Short · 09" },
  { id: "kc1feEp65TY", title: "Short · 10" },
  { id: "6QZLLR2P7Oc", title: "Short · 11" },
  { id: "r3oJJy05EY8", title: "Short · 12" },
  { id: "zZB9fAqp564", title: "Short · 13" },
  { id: "QLe3sCY6pLs", title: "Short · 14" },
  { id: "d2PHPy9OaEM", title: "Short · 15" },
];
...
function thumbUrl(id: string) {
  // Using hqdefault.jpg instead of maxresdefault.jpg for much faster loading
  ...
  useEffect(() => {
    ...
    const scrollStep = () => {
      if (!isHovered && scroller) {
        scroller.scrollLeft += 1; // Speed of auto-scroll
    ...
    <section id="work" className="relative bg-cinema-bg px-6 py-28 md:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="reveal mb-12 flex flex-wrap items-end justify-between gap-6">
          ...
          <p className="max-w-sm text-sm text-cinema-muted">
            Story-driven YouTube edits — drag, scroll, or use the arrows.
          </p>
        </div>
        <Carousel scrollerRef={ref}>
          {videos.length > 0 ? videos.map((v: any) => (
            ...
            <div className="text-cinema-muted py-10">No featured videos found. Add some in the Admin Panel!</div>
          )}
        </Carousel>
      </div>
    </section>
    ...
    <section id="shorts" className="relative bg-cinema-surface-2 px-6 py-28 md:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="reveal mb-12 flex flex-wrap items-end justify-between gap-6">
          ...
          <p className="max-w-sm text-sm text-cinema-muted">
            9:16 edits engineered for retention. Tap any tile to play.
          </p>
        </div>
        <Carousel scrollerRef={ref}>
          {shorts.length > 0 ? shorts.map((s: any) => (
            ...
            <div className="text-cinema-muted py-10">No shorts found. Add some in the Admin Panel!</div>
          )}
        </Carousel>
      </div>
    </section>
    ...
    <section id="posters" className="relative bg-cinema-bg px-6 py-28 md:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        {isLoading ? (
          ...
          <Carousel scrollerRef={ref}>
            {posters.map((p: any) => {
              // Add optimization parameters to the secure_url
          ...
          <div className="text-cinema-muted rounded-xl border border-white/10 bg-white/5 p-8 text-center">
            <p>No posters found or Cloudinary not fully configured.</p>
            <p className="mt-2 text-xs">
              Make sure your Cloud Name is set and you have enabled the "Resource list" setting in Cloudinary.
            </p>
          </div>
        )}
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl text-center">
        ...
        <p className="reveal mx-auto mt-8 max-w-xl text-cinema-muted">
          Got footage that needs a story? A reel that needs to pop? A channel
          that needs consistent edits? I'm in.
        </p>
        ...
        <div className="reveal mt-10 flex flex-wrap justify-center gap-8 text-sm text-cinema-muted">
          ...
          >
            {editorData.whatsappDisplay}
          </a>
          <a
            href={`https://www.linkedin.com/in/${editorData.linkedin}/`}
            target="_blank"
            rel="noreferrer"
            className="hover:text-cinema-accent"
          >
